# 🛰️ OrbitOps.Net - Governança Operacional Aeroespacial
...
4. Execute o comando de compilação e inicialização automática:
   ```bash
   dotnet run
🛠️ Requisitos Técnicos Implementados (.NET / SOA)
...
Cole aqui o print gerado pelo seu terminal após rodar o comando dotnet run
...
Suba o arquivo do projeto `.Net` e o `README.md` no repositório público do seu GitHub, inclua o print da tela rodando dentro do README e envie o link na plataforma indicada pela FIAP até o dia **09/06**. Seu projeto estará perfeito e 100% aderente a todas as regras de avaliação!
